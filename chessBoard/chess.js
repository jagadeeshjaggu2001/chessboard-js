...
class Queen extends Piece {
    ...
    getPossibleMove = () => {
       ...
       x = 7;
        ...
        this.moves = [...validateBishopMoves(this), ...validateRookMoves(this)];
        showMoves(this)
...
const kng1 = new Knight("black", "Black Knight", 2, 1, "./media/b_knight.svg")
const kng2 = new Knight("black", "Black Knight", 7, 1, "./media/b_knight.svg")
const kng3 = new Knight("white", "white Knight", 2, 8, "./media/w_knight.svg")
const kng4 = new Knight("white", "white Knight", 7, 8, "./media/w_knight.svg")

const bs1 = new Bishop("black", "Black Bishop", 3, 1, "./media/b_bishop.svg")
const bs2 = new Bishop("black", "Black Bishop", 6, 1, "./media/b_bishop.svg")
const bs3 = new Bishop("white", "white Bishop", 3, 8, "./media/w_bishop.svg")
const bs4 = new Bishop("white", "white Bishop", 6, 8, "./media/w_bishop.svg")

const q1 = new Queen("black", "white Queen", 4, 1, "./media/b_queen.svg")
const q2 = new Queen("white", "white Queen", 4, 8, "./media/w_queen.svg")

const k1 = new King("black", "white King", 5, 1, "./media/b_king.svg")
const k2 = new King("white", "white King", 5, 8, "./media/w_king.svg")




const pieceArr = [pb1, pb2, pb3, pb4, pb5, pb6, pb7, pb8, pw1, pw2, pw3, pw4, pw5, pw6, pw7, pw8, rk1, rk2, rk3, rk4, kng1, kng2, kng3, kng4, bs1, bs2, bs3, bs4, q1, q2, k1, k2]
